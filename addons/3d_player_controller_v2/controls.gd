...
const BUTTON_0 = "button_0" 		## Key: Space, Controller: Ⓐ (Microsoft), Ⓑ (Nintendo), ⮾ (Sony)
const BUTTON_1 = "button_1" 		## Key: Shift, Controller: Ⓑ (Microsoft), Ⓐ (Nintendo), 🄋 (Sony)
const BUTTON_2 = "button_2" 		## Key: E, Controller: Ⓧ (Microsoft), Ⓨ (Nintendo), 🟗 (Sony)
const BUTTON_3 = "button_3" 		## Key: Ctrl, Controller: Ⓨ (Microsoft), Ⓧ (Nintendo), 🟕 (Sony)
const BUTTON_4 = "button_4"			## Key: Mouse Button 0 (left click), Controller: 🄻1
const BUTTON_5 = "button_5"			## Key: Mouse Button 1 (right click), Controller: 🅁1
const BUTTON_6 = "button_6"			## Key: Mouse Button 3 (forward), Controller: 🄻2
const BUTTON_7 = "button_7"			## Key: Mouse Button 4 (backward), Controller: 🅁2
const BUTTON_8 = "button_8"			## Key: F5, Controller: ⧉ (Microsoft), ⊖ (Nintendo), ⧉ (Sony)
const BUTTON_9 = "button_9"			## Key: Esc, Controller: ☰ (Microsoft), ⊕ (Nintendo), ☰ (Sony)
const BUTTON_10 = "button_10"		## Key: Mouse scroll up, Controller: Ⓛ3
const BUTTON_11 = "button_11"		## Key: Mouse scroll down, Controller: Ⓡ3
const BUTTON_12 = "button_12"		## Key: Tab, Controller: D-Pad Up
const BUTTON_13 = "button_13"		## Key: Q, Controller: D-Pad Down
const BUTTON_14 = "button_14"		## Key: B,Controller: D-Pad Left
const BUTTON_15 = "button_15"		## Key: T, Controller: D-Pad Right
const SCREENSHOT = "screenshot"		## Key: F2, Controller: N/A
const DEBUG = "debug"				## Key: F3, Controller: N/A
const LOOK_DOWN = "look_down"		## Key: Down Arrow, Controller: Right Stick Down
const LOOK_LEFT = "look_left"		## Key: Left Arrow, Controller: Right Stick Left
const LOOK_RIGHT = "look_right"		## Key: Right Arrow, Controller: Right Stick Right
const LOOK_UP = "look_up"			## Key: Up Arrow, Controller: Right Stick Up
const MOVE_DOWN = "move_down"		## Key: S, Controller: Left Stick Down
const MOVE_LEFT = "move_left"		## Key: A, Controller: Left Stick Left
const MOVE_RIGHT = "move_right"		## Key: D, Controller: Left Stick Right
const MOVE_UP = "move_up"			## Key: W, Controller: Left Stick Up
