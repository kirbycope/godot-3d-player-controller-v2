...
# Running 🔵 Mixamo animations (sword and shield)
const MIX_ANIMATION_SWORD_AND_SHIELD := "Running_Sword_And_Shield/mixamo_com"
const MIX_ANIMATION_BACKWARD_SWORD_AND_SHIELD := "Running_Backward_Sword_And_Shield/mixamo_com"
const MIX_ANIMATION_STRAFE_LEFT_SWORD_AND_SHIELD := "Running_Strafe_Left_Sword_And_Shield/mixamo_com"
const MIX_ANIMATION_STRAFE_RIGHT_SWORD_AND_SHIELD := "Running_Strafe_Right_Sword_And_Shield/mixamo_com"
