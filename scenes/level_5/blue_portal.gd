...
const BLUE_PORTAL_MATERIAL = preload("res://scenes/level_5/materials/blue_portal_material.tres")
...
func _ready() -> void:
	...
	# Get the "red" portal
	exit_portal = $"../RedPortal/Portal3D"
	if exit_portal == null:
	...
	if player_camera == null:
		push_error("BluePortal: Player Camera3D not found")
	else:
