...
const RED_PORTAL_MATERIAL = preload("res://scenes/level_5/materials/red_portal_material.tres")
...
func _ready() -> void:
	...
	# Get the "blue" portal
	exit_portal = $"../BluePortal/Portal3D"
	if exit_portal == null:
	...
	if player_camera == null:
		push_error("RedPortal: Player Camera3D not found")
	else:
